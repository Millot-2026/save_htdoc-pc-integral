...
$screenshot = ''; // On désactive le screenshot principal pour utiliser les sections responsives
$basePath   = '../';
$appHref    = 'dashboard-designer/';

$sections = [
    [
        'title' => 'Architecture et Pilotage (Accueil)',
        'images' => [
            'desktop' => 'images/images-workstation/01-capture-dd-desktop-accueil.png',
            'tablet'  => 'images/images-workstation/01-capture-dd-tablet-accueil.png',
            'mobile'  => 'images/images-workstation/01-capture-dd-mobile-accueil.png'
        ],
    ...
    [
        'title' => 'Raccourcis et Favoris',
        'images' => [
            'desktop' => 'images/images-workstation/02-capture-dd-desktop-raccourcis.png',
            'tablet'  => 'images/images-workstation/02-capture-dd-tablet-raccourcis.png',
            'mobile'  => 'images/images-workstation/02-capture-dd-mobile-raccourcis.png'
        ],
        'figcaption' => 'Section de navigation rapide vers les ressources',
    ],
    [
        'title' => 'Lanceur de Projets',
        'images' => [
            'desktop' => 'images/images-workstation/03-capture-dd-desktop-lanceur.png',
            'tablet'  => 'images/images-workstation/03-capture-dd-tablet-lanceur.png',
            'mobile'  => 'images/images-workstation/03-capture-dd-mobile-lanceur.png'
        ],
        'figcaption' => 'Interface de démarrage rapide des projets locaux',
    ],
    [
        'title' => 'Testeur Google Fonts',
        'images' => [
            'desktop' => 'images/images-workstation/04-capture-dd-desktop-googlefont-tester.png',
            'tablet'  => 'images/images-workstation/04-capture-dd-tablet-googlefont-tester.png',
            'mobile'  => 'images/images-workstation/04-capture-dd-mobile-googlefont-tester.png'
        ],
        'figcaption' => 'Module d\'expérimentation de polices d\'écriture',
    ],
    [
        'title' => 'Générateur de Lorem Ipsum',
        'images' => [
            'desktop' => 'images/images-workstation/05-capture-dd-desktop-lorem-pxtorem.png',
            'tablet'  => 'images/images-workstation/05-capture-dd-tablet-lorem-generator.png',
            'mobile'  => 'images/images-workstation/05-capture-dd-mobile-lorem-generator.png'
        ],
        'figcaption' => 'Outil de génération de textes factices',
    ],
    [
        'title' => 'Laboratoire CSS',
        'images' => [
            'desktop' => 'images/images-workstation/06-capture-dd-desktop-css-lab.png',
            'tablet'  => 'images/images-workstation/07-capture-dd-tablet-css-lab.png',
            'mobile'  => 'images/images-workstation/07-capture-dd-mobile-css-lab.png'
        ],
        'figcaption' => 'Zone d\'expérimentation et bac à sable CSS',
    ],
    [
        'title' => 'Notes rapides',
        'images' => [
            'desktop' => 'images/images-workstation/07-capture-dd-desktop-note-rapide.png',
            'tablet'  => 'images/images-workstation/08-capture-dd-tablet-note -rapide.png',
            'mobile'  => 'images/images-workstation/08-capture-dd-mobile-note -rapide.png'
        ],
        'figcaption' => 'Prise de notes et organisation',
    ],
    [
        'title' => 'Développements',
        'images' => [
            'tablet'  => 'images/images-workstation/09-capture-dd-tablet-developpements.png',
            'mobile'  => 'images/images-workstation/09-capture-dd-mobile-developpements.png'
        ],
        'figcaption' => 'Suivi des évolutions du projet',
    ]
];
                ...
                <div class="detail-section">
                    ...
                    <figure class="press-figure">
                        <picture>
                            ...
                            <?php endif; ?>
                            <?php
                                // Fallback image (mobile ou le premier disponible)
